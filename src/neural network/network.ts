 ...
 * @description  Neural Network: Network
...
export class Network {
  ...
  public generateNetworkLayers(
    ...
    const inputLayer = new Layer(index, this.neuronType);
    ...
    for (const i in hidden) {
      const newHiddenLayer = new Layer(index, this.neuronType);
    ...
    const outputLayer = new Layer(index, this.neuronType);
  ...
  public loadNetworkWithData(data: INetworkData): void {
    ...
    for (const i in data.neurons) {
      // Create new layer
      const newLayer = new Layer(index, this.neuronType);
